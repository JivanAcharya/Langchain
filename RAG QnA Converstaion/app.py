...
embeddings = HuggingFaceEmbeddings(model_name = "all-MiniLM-L-v2")
...
if api_key:
    ...
    contextualized_q_system_prompt=(
        "Given a chat history and the latest use question"
    ...
    system_prompt =(
        ...
        "dont't know. Uset three sentences maximum and keep the"
        "answer concise."
        "\n\n"
        "{context}"
    )
